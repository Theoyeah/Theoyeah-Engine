...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Freaky on a Friday Night",  "Jouer a Fnf.... le vendredi soir",				    'friday_night_play',	 false],
		["Doudou !",		                  "Finir le week D!",				                    'weekd',			    false],
		["Coeur de Doudou",			   "Finir Le week O",				'weeko',			false],
		["Boyfriend.json is now an ad///moiernvk",			"Finir le Week Bonus",		'corrupt',			false],
		["Mangeur de KFC",			  "Blabla finik l waak Chljoe *en train de roter*",	'chloe',			false],
		["Sus",	                               "Tes sus, amogus",	                                'sus',				false],
		["J'aime des fraises",          "Finir Strawberry avec 0 erreurs.",			        'strawberry',				false],
		["Bon copain",			         "Finir rematch sans fautes ",			'rematch',	false],
		["Chante trop ?",		        "garde une note longtemps.",					    'oversinging',			false],
		["pc de patate",				 "Tu joue sur Intel Graphics ?",		'toastie',				false],
		["Doudou hack",                "Finir Halico sans fautes",                         'halico',				false],	
		["Collectiondou",               "Tu as découvert un nouveau doudou !",                                   'weeku',               false],
		["Bons temps...",                "Finir le Week D 2",                                   'weekdd',               false],
		["Failure of Extermination",                "Finir le jeu...?",                                   'theend',               false],
		["True Reality",                "::::::::OZJS?DK?",                                   'theoyeah',               false]
	];
