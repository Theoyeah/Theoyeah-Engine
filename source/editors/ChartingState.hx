...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Disable Botplay', 'Disables botplay'],
		['Move Window', 'Value 1: x\nValue 2: y\nMoves the entire window to that position'],
		['Toggle Minimize Window', 'Value 1: true or false'],
		['Toggle Maximize Window', 'Value 1: true or false'],
	...
	**/
	...
	var zoomList:Array<Float> = [
		...
		#if MORE_ZOOM
		, 48,
		80 // lol, a thing, this converts the chart to black, be careful!
		#end
	];
	var curZoom:Int = 2;
		...
		else if (id == FlxUINumericStepper.CHANGE_EVENT && (sender is FlxUINumericStepper))
		{
			...
			else if(curSelectedNote != null)
			{
				if(sender == value1InputText) {
					...
					if(curSelectedNote[1][curEventSelected] != null)
					{
						curSelectedNote[1][curEventSelected][3] = value1InputText.text;
						updateGrid();
					}
				}
		...
		if (!blockInput)
		{
			...
			if (FlxG.keys.justPressed.BACKSPACE) {
				...
				openSubState(new Prompt("You haven't saved your progress\n\nProceed?", 0, function() {
					...
					if(MasterEditorMenu.chartToMaster) {
